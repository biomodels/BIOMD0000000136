...
`pip install git+https://github.com/biomodels/BIOMD0000000136.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/BIOMD0000000136.git@20140916`

## Usage

Importing the model package.

`import BIOMD0000000136 as model`
...
Neurons?_ Figure1(O) threshold variability has been reproduced by MathSBML.
The ODE and the parameters values are taken from the a paper _Simple Model of
...
parameters and different stimulus function or events.a=0.03; b=0.25; c=-60;
d=4; V=-64; u=b*V;
